...
def convert_annotation(list_txt, output_path, image_dir, anno_dir, class_names):
    ...
    with open(list_txt, "r") as f, open(output_path, "w") as wf:
        while True:
            ...
            annotation = (
                os.path.abspath(im_p) + " " + " ".join(box_annotations) + "\n"
            )
...
def convert_voc(
    ...
    # Training set.
    convert_annotation(
        train_list_txt, train_output, image_dir, anno_dir, class_names
    )
    ...
    # Validation set.
    convert_annotation(
        val_list_txt, val_output, image_dir, anno_dir, class_names
    )
